  ...
  "super-admin": {
    ...
    items: [
      { label: "Overview", href: "/dashboard/super-admin", icon: "home" },
      {
        ...
        children: [
          { label: "Leadership", href: "/dashboard/super-admin/leadership", icon: "shield" },
  ...
  admin: {
    ...
    items: [
      { label: "Overview", href: "/dashboard/admin", icon: "home" },
      {
        ...
        icon: "user-management",
        children: [
          { label: "Leadership", href: "/dashboard/admin/leadership", icon: "shield" },
          { label: "Users", href: "/dashboard/admin/users", icon: "users" },
          { label: "Lecturers", href: "/dashboard/admin/lecturers", icon: "lecturer" },
          { label: "Applicants", href: "/dashboard/admin/applicants", icon: "applicants" },
          { label: "Students", href: "/dashboard/admin/students", icon: "students" },
        ],
      },
      { label: "Schools", href: "/dashboard/admin/schools", icon: "schools" },
      ...
      { label: "Manage Hero", href: "/dashboard/admin/hero", icon: "hero" },
      { label: "Roles", href: "/dashboard/admin/roles", icon: "shield" },
      { label: "Widgets", href: "/dashboard/admin/widgets", icon: "widgets" },
